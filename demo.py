...
p0 = cv2.goodFeaturesToTrack(old_gray, mask=None, **feats) # back to shi-tomasi corners
...
while True:
    ...
    if p1 is not None:
        ...
        cv2.putText(output_img, "MODE: TRAINING (EXPLORING)", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
...
while True:
    ...
    if p1 is not None:
        ...
        cv2.putText(output_img, "MODE: TESTING (DQN JUDGE)", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
